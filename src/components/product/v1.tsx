    ...
    return (
        <>
            <div className='bg-slate-50 my-2 w-[90%] relative product-item  transition-all border-solid border-2 border-slate-100 rounded-md '>
                <Link className='text-none h-[200px] flex justify-center items-center flex-col overflow-hidden mt-4 ' href={`#`}>
                ...
                <Link href={`#`} className="text-name-product mt-4">{item.name}</Link>
